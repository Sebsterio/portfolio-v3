...
export const projects: Project[] = [
	{
		...
		intro: 'Led the architecture and delivery of a production-ready cross-platform component library serving web, iOS, and Android platforms. This foundational system unified the design language across all Bounce products while reducing technical debt and enabling faster feature development.',
		challenge: 'Bounce had grown rapidly across multiple platforms, resulting in fragmented UI components, inconsistent user experiences, and duplicated effort across web and mobile teams. The company needed a unified design system that could scale across platforms while maintaining native performance and platform-specific conventions.',
		solution: 'I architected a monorepo-based component library using Next.js for web and React Native for mobile platforms. The system featured shared component logic with platform-specific rendering adapters, type-safe APIs using TypeScript generics, comprehensive Storybook documentation, automated testing suite covering unit/integration/visual regression, and CI/CD pipeline with automated publishing.',
		impact: [
	...
	},
	{
		...
		intro: 'Developed comprehensive event management ecosystem consisting of internal back-office solution and customer-facing progressive web app. The system streamlined operations, financial tracking, and attendee experience for a major music festival.',
		challenge: 'Manual processes for inventory, payments, and customer communication created operational bottlenecks. No unified system existed for managing festival logistics, financial reporting, or attendee experience. The festival needed real-time operational visibility and seamless customer interactions.',
	...
	},
	{
		...
		intro: 'Led comprehensive platform modernization effort for school-management SaaS, rebuilding critical features while maintaining service continuity for thousands of active users. Implemented modern authentication, comprehensive testing, and accessibility compliance.',
		challenge: 'Critical features built on outdated systems caused stability issues and blocked new development. No testing infrastructure or accessibility compliance existed. Multiple products had siloed authentication creating friction for users accessing different tools.',
		solution: 'Implemented incremental modernization: rebuilt core features in modern React with backward compatibility, established comprehensive testing suite with Jest/RTL, implemented cross-product SSO with MSAL, achieved WCAG AA compliance, built AI chat interface for user support, and created design system with 30+ documented components.',
		impact: [
	...
	},
	{
		...
		intro: 'Served as founding frontend developer, establishing entire frontend architecture, development workflow, and code standards from scratch. Built production application with complex Web3 integrations while mentoring junior developers.',
		challenge: 'As first frontend developer, needed to architect scalable React application, establish CI/CD pipeline, implement Web3 wallet integration, and create reusable component library while building core product features simultaneously.',
		solution: 'Architected scalable React application with custom component library, established CI/CD pipeline with automated deployment, implemented Web3 wallet integration with robust state management and error handling, created technical documentation and code review processes, and mentored junior developers.',
		impact: [
	...
	},
	{
		...
		intro: 'Architected and built centralized micro frontend for payment processing, creating unified API layer abstracted from provider specifics. Enabled multiple teams to integrate payment methods without touching core system.',
		challenge: 'Each team maintained separate payment integrations, causing code duplication and making new provider integration painfully slow. Payment-related bugs in finance section cost £16k monthly in lost revenue.',
		solution: 'Architected centralized micro frontend for payment processing with unified API layer and plugin architecture. Refactored finance application section fixing critical bugs. Reduced payment provider integration time from weeks to days.',
		impact: [
	...
	},
	{
		...
		intro: 'Designed and built intelligent survey system that dynamically generates personalized questions based on pet type and symptoms. Created admin portal for clinics to customize surveys and search case history.',
		challenge: 'Pet owners unable to accurately describe symptoms, leading to incomplete information before appointments. Clinics had no searchable history of cases. Process was slow and error-prone.',
	...
	},
	{
		...
		intro: 'Built modern PWA using React and Redux for state management. Integrated Firebase for authentication and real-time inventory, Stripe for payment processing. Implemented service workers for offline catalog browsing.',
		challenge: 'Existing platform was slow, not mobile-optimized, and lacked modern payment options. High cart abandonment rate on mobile devices. No offline capabilities for browsing catalog.',
